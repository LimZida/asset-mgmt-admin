package com.mcnc.assetmgmt.token.entity;
 ...
 * title : entity
 *
 * description : token 테이블 컬럼 매핑용 entity
 *
...
public class Token {
    ...
    @Builder
    private Token(String userId, String refreshToken, Timestamp createDate, Timestamp updateDate){
        this.userId=userId;
        this.refreshToken = refreshToken;
