package com.mcnc.assetmgmt.trlog.entity;
 ...
 * title : entity
 *
 * description : trlog 테이블 컬럼 매핑용 entity
 *
...
public class Trlog {
    ...
    @Builder
    private Trlog(int trLogSeq, String jobName,
                  String successYn, String userId, String tranId, String errCode, String errDetail, Timestamp createDate){
        this.trLogSeq = trLogSeq;
