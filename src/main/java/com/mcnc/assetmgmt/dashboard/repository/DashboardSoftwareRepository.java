...
/**
 * title : DashboardSoftwareRepository
 *
 * description :  대시보드 소프트웨어 자산현황 JPA 쿼리
 *
 ...
 **/
@Repository
public interface DashboardSoftwareRepository extends JpaRepository<SoftwareEntity,Long> {
    List<SoftwareEntity> findAll();
    List<SoftwareEntity> findBySwDivAndDeleteYn(Code swDiv, boolean deleteYn);
}
